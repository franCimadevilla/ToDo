    ...
    fn execute(&mut self, manager: &mut Manager) -> UndoRedoData {
        match self {
            ...
            Command::EditTask { id, new_fields } => {
                ...
                manager
                    .todo_list
                    .edit_task(id.as_ref(), (new_fields.0.as_ref(), &new_fields.1));
