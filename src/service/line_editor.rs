...
pub trait LineEditor {
    fn readline_with_initial(&mut self, prompt: &str, initial: (&str, &str)) -> Result<String, String>;
}
...
impl LineEditor for MockLineEditor {
    fn readline_with_initial(&mut self, _prompt: &str, _initial: (&str, &str)) -> Result<String, String> {
